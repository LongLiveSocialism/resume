...
Proposed an optimized structure for a highly non-convex system based on convex optimization method.
...
\begin{itemize}
  ...
  \item A first author paper on this topic has been submitted to \textit{IEEE trans. on Signal Processing}.
\end{itemize}
