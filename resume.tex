...
Designed a LTE simulation platform for R\&S, mainlly a simplified realization of LTE physical layer.
\begin{itemize}
\item based on c++ 11, 10000 lines of code (my part).
\item system design and integration
\item turbo coding \& decoding, mix-radix fft, tons of control logic.
\end{itemize}
